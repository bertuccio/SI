...
ALTER TABLE ONLY autorlibro
    ADD CONSTRAINT autorlibro_isbn_fkey FOREIGN KEY (isbn) REFERENCES libro(isbn) on update cascade;
...
ALTER TABLE ONLY correccion
    ADD CONSTRAINT correccion_isbn_fkey FOREIGN KEY (isbn) REFERENCES proyecto(isbn) on update cascade;
...
ALTER TABLE ONLY correccion
    ADD CONSTRAINT correccion_isbn_fkey1 FOREIGN KEY (isbn, n_pagina) REFERENCES pagina(isbn, n_pagina);
...
ALTER TABLE ONLY generolibro
    ADD CONSTRAINT generolibro_isbn_fkey FOREIGN KEY (isbn) REFERENCES libro(isbn) on update cascade;
...
ALTER TABLE ONLY pagina
    ADD CONSTRAINT pagina_isbn_fkey FOREIGN KEY (isbn) REFERENCES proyecto(isbn) on update cascade;
...
ALTER TABLE ONLY proyecto
    ADD CONSTRAINT proyecto_isbn_fkey FOREIGN KEY (isbn) REFERENCES libro(isbn) on update cascade;
...
ALTER TABLE ONLY traductorlibro
    ADD CONSTRAINT traductorlibro_isbn_fkey FOREIGN KEY (isbn) REFERENCES libro(isbn) on update cascade;
